...
\title[Trabajo de Fin de Grado]{La Prueb ZIP de Conway del Teorema de Clasificación de Superficies} % The short title appears at the bottom of every slide, the full title is only on the title page
...
La prueba ZIP de Conway hace una demostración informal del Teorema de Clasificación de Superficies. \pause

\begin{tma}[Clasificación de Superficies]
Sea $S$ una superficie compacta. Entonces $S$ es homeomorfa a una y sólo una de las siguientes superficies: \pause
\begin{itemize}
\item<1-> La esfera $\Esfera$. \pause
\item<2-> Una suma conexa de copias del toro $\Toro \# \dots \# \Toro$. \pause
\item<3-> Una suma conexa de copias del plano proyectivo $\Proyectivo \# \dots \# \Proyectivo$.
...
\item<1-> 1863 - Möbius
\item<2-> 1866 - Jordan
\item<3-> 1888 - von Dick
\item<4-> 1907 - Dehn y Heegard
\item<5-> 1915 - Alexander
\item<6-> 1920 - Brahana
\item<7-> 1925 - Radó
\end{itemize}
...
\begin{center}
Prueba de Irrelevancia Cero \pause 
\end{center}
...
\item La forma normal se basa en el concepto de suma conexa. \pause
\end{itemize}
\end{block}
...
\pause
\begin{itemize}
\item No se definen algunos conceptos utilizados. \pause
\item No se desarrollan los resultados en profundidad. \pause
...
\begin{itemize}
\frametitle{Trabajo}
\item Estudiar los conceptos previos.\pause
\item Estudiar la demostración clásica.\pause
\item Tratamiento riguroso de la prueba ZIP.\pause
...
La definimos en términos de complejos simpliciales.
\begin{figure}
...
\begin{frame}
\frametitle{Teorema de Radó}
Idea de la demostración (Thomassen):\pause
\begin{itemize}
\item Recubrir la superficie con un número finito de discos coordenados.\pause
\item Triangular cada disco de forma que sea compatible con los anteriores.\pause
\end{itemize}
Dificultades:\pause
\begin{itemize}
...
\begin{frame}
\frametitle{Perforaciones}\pause
\begin{prop}
Toda superficie con borde compacta es homeomorfa a una superficie compacta con perforaciones.\pause
\end{prop}
...
\frametitle{Suma Conexa}
\begin{enumerate}
\item Se consideran dos variedades $M_1$ y $M_2$. \pause
\item Realizamos una perforación en cada variedad $\longrightarrow$ variedades con borde $M_1^o$ y $M_2^o$.\pause
\item Consideramos un homeomorfismo $f:\partial M_1^o \to \partial M_2^o$.\pause
\item Relacionamos en $M_1^o\amalg M_2^o$ cada punto de $\partial M_1^o$ con su imagen por $f$.\pause
\item Al espacio cociente $M=\frac{M_1^o\amalg M_2^o}{\sim}$ lo llamamos \enfatiza{suma conexa} de $M_1$ y $M_2$.\pause
\end{enumerate}
\end{frame}
%------------------------------------------------
...
\begin{itemize}
\item \enfatiza{zip}: identificación entre dos subconjuntos del borde de $M$. 
...
\begin{frame}
\frametitle{Theorem}
\begin{tma}[Mass--energy equivalence]
$E = mc^2$
\end{tma}
\end{frame}
