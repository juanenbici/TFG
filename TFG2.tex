...
Sea $f$ un homeomorfismo de una curva simple conexa $C$ en una curva simple conexa $C'$. Entonces $f$ se puede extender a un homeomorfismo de todo el plano.
\end{tma}
...
\centering
\begin{tikzpicture}[use optics, line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm, scale=0.7]
\draw [-<-](0,2)-- (2,0);
\draw [-<-](2,0)-- (0,-2);
\draw [-<-](0,-2)-- (-2,0);
\draw [-<-](-2,0)-- (0,2);
