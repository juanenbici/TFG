...
Toda bola en $\R^n$ es una n-celda, y el \autoref{teo:convexo_homeom_esfera} nos da otros muchos ejemplos: un intervalo cerrado es una 1-celda cerrada, toda región poligonal es una 2-celda cerrada, y un tetraedro sólido es una 3-celda cerrada. Lsd 0-celdas son los conjuntos unitarios.
