...
Sea $\sigma$ un $k$-símplice. Cada símplice cubierto por un subconjunto no vacío de vértices de $\sigma$ se llama \enfatiza{cara de $sigma$}. Las caras que no son iguales a $\sigma$ se llaman \enfatiza{caras propias}. Las caras $0$-dimensionales de $\sigma$ son sus vértices, y a las caras $1$-dimensionales se les llama \enfatiza{lados}. Las caras $(k-1)$-dimensionales de un $k$-símplice se llaman 
\end{defin}
