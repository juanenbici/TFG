...
\begin{eje}
Sea $S$ una superficie. Entonces la suma conexa $S\# \Esfera$ es homeomorfa a $S$ (ver \autoref{fig:suma_toro_esfera}).
\end{eje}
...
\fill[color=gray!20][rotate around={-14.04:(3.33,1.31)}] (3.33,1.31) ellipse (0.32cm and 0.24cm);
