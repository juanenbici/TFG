...
\end{tikzpicture}
\caption{La representación $\mathcal{P}_1=\langle S_1,a,b,c\mid W_1c^{-1}b^{-1}a^{-1},abc\rangle$.\label{fig:suma_conexa_rep_pol_a}}
\end{figure}
...
\end{tikzpicture}
\caption{Hacer que los pares torcidos sean adyacentes.\label{fig:PASO3}}
\end{figure}
...
\end{tikzpicture}
\caption{Subdivisión baricéntrica de un 2-símplice que tiene dos lados en $\partial M$.\label{fig:baricentrica}}
\end{figure}
...
\centering
\begin{tikzpicture}[use optics, >=angle 60, scale=1.5]

\fill[line width=1.2pt,fill=black,fill opacity=0.1] (0,0) -- (0.9238207149966959,0.3828253995531037) -- (1.3063621711370152,1.3067637277623212) -- (0.9235367715839117,2.230584442759017) -- (-0.00040155662530578324,2.6131258988993364) -- (-0.9242222716220017,2.230300499346233) -- (-1.3067637277623212,1.3063621711370155) -- (-0.9239383282092178,0.38254145614031965) -- cycle;

\draw  [->-]  (0,0) -- (0.9238207149966959,0.3828253995531037)node[midway,below] {$b_2$};
\draw  [->-](0.9238207149966959,0.3828253995531037)-- (1.3063621711370152,1.3067637277623212)node[midway,below] {$a_2$};
\draw  [-<-](1.3063621711370152,1.3067637277623212)-- (0.9235367715839117,2.230584442759017)node[midway,below] {$b_2$};
\draw  [-<-](0.9235367715839117,2.230584442759017)-- (-0.00040155662530578324,2.6131258988993364)node[midway,below] {$a_2$};
\draw  [->-](-0.00040155662530578324,2.6131258988993364)-- (-0.9242222716220017,2.230300499346233)node[midway,below] {$b_1$};
\draw  [->-](-0.9242222716220017,2.230300499346233)-- (-1.3067637277623212,1.3063621711370155)node[midway,below] {$a_1$};
\draw  [-<-](-1.3067637277623212,1.3063621711370155)-- (-0.9239383282092178,0.38254145614031965)node[midway,below] {$b_1$};
\draw  [-<-](-0.9239383282092178,0.38254145614031965)-- (0,0)node[midway,below] {$a_1$};
\draw  [-<-](0,0)-- (-0.5128819104663424,1.2073243438172108);
\draw  [-<-](0,0)-- (0.4909162594319499,1.202150126446601);
...
\centering
\begin{tikzpicture}[use optics]
\fill[ shift={(3,0)},fill=black,fill opacity=0.1] (0,0) -- (1,0) -- (1.8660254037844386,0.5) -- (2.366025403784439,1.3660254037844388) -- (2.366025403784439,2.3660254037844384) -- (1.8660254037844393,3.232050807568877) -- (1,3.7320508075688776) -- (0,3.7320508075688776) -- (-0.8660254037844384,3.2320508075688785) -- (-1.3660254037844388,2.3660254037844393) -- (-1.3660254037844393,1.3660254037844402) -- (-0.8660254037844393,0.5) -- cycle;

\draw [ shift={(3,0)}, ->- ] (0,0)-- (1,0)node[midway,below] {$c_1$};
\draw [ shift={(3,0)},-<-] (1,0)-- (1.8660254037844386,0.5)node[midway,below] {$c_2$};
\draw [ shift={(3,0)},->-] (1.8660254037844386,0.5)-- (2.366025403784439,1.3660254037844388)node[midway,below] {$c_2$};
\draw [ shift={(3,0)},->-] (2.366025403784439,1.3660254037844388)-- (2.366025403784439,2.3660254037844384)node[midway,below] {$b_2$};
\draw [ shift={(3,0)},->-] (2.366025403784439,2.3660254037844384)-- (1.8660254037844393,3.232050807568877)node[midway,below] {$a_2$};
\draw [ shift={(3,0)},-<-] (1.8660254037844393,3.232050807568877)-- (1,3.7320508075688776)node[midway,below] {$b_2$};
\draw [ shift={(3,0)},-<-] (1,3.7320508075688776)-- (0,3.7320508075688776)node[midway,below] {$a_2$};
\draw [ shift={(3,0)},->-] (0,3.7320508075688776)-- (-0.8660254037844384,3.2320508075688785)node[midway,below] {$b_1$};
\draw [ shift={(3,0)},->-] (-0.8660254037844384,3.2320508075688785)-- (-1.3660254037844388,2.3660254037844393)node[midway,below] {$a_1$};
\draw [ shift={(3,0)},-<-] (-1.3660254037844388,2.3660254037844393)-- (-1.3660254037844393,1.3660254037844402)node[midway,below] {$b_1$};
\draw [ shift={(3,0)},-<-] (-1.3660254037844393,1.3660254037844402)-- (-0.8660254037844393,0.5)node[midway,below] {$a_1$};
\draw [ shift={(3,0)},-<-] (-0.8660254037844393,0.5)-- (0,0) node[midway,below] {$c_1$};

\end{tikzpicture}
\caption{ }
\end{subfigure}
\caption{La superficie $\Toro \# \Toro$  con dos perforaciones.}
\end{figure}
...
%(A PARTIR DE AQUI NO SE MUY BIEN COMO ORIENTARLO... CON OPERACIONES ELEMENTALES O COMO HACE EL???) 
\end{proof}
