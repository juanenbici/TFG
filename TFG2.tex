...
\end{proof}
Aunque Conway hasta ahora haya hablado de superficies con perforaciones (es decir, de superficies con borde), en el teorema final que veremos ahora decide omitirlas. Aprovechamos y damos directamente la clasificación de superficies con borde.
...
Hasta ahora hemos demostrado, con dos enfoques distintos, que toda superficie con borde compacta es homeomorfa a una esfera, a una suma conexa de copias del toro o a una suma conexa de copias del plano proyectivo junto con un número finito de perforaciones. Sin embargo no hemos demostrado que estas tres superficies estándar no sean homeomorfas entre sí. En este capítulo completaremos por tanto la parte de la prueba que nos falta. 
