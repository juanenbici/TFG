...
\item[(iii)] Con una construcción análoga a la del apartado anterior, hacer una perforación sobre una superficie $S'$, con el borde con etiquetas asociadas a una representación poligonal de $S$ e identifacarlas da lugar a la suma conexa $S\# S'$. 
\end{itemize}
\end{prop}
\begin{proof}
...
\end{itemize}
Por la \autoref{obs:suma_esfera}, queda demostrado.
((Tengo que decir algo sobre si aparecen más componentes conexas del borde en las perforaciones?? Irían pegadas una detrás de otra, no se si habría que mencionarlo))
\end{proof}
