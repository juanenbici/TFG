...
\filldraw [color=gray!20] (-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);
\filldraw [shift={(0,-3)},color=gray!20] (-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);
...
\filldraw [color=gray!20] (3.3,-.5) -- (3.3,.5) -- (4.8,.5) -- (4.8, -.5);
...
\begin{eje}\label{eje:klein}%%%%EJE: Botella Klein
...
Vamos ahora a dar un método para representar todas las superficies compactas (con y sin borde) como regiones poligonales del plano. A su vez asociaremos a cada región poligonal, y por tanto a cada superficie compacta, una secuencia de símbolos llamada palabra. 
...
\fill[ fill=gray!20] (-1.0734974348383717,1.9534822942323429) -- (-1.2251018153471387,1.062806558743338) -- (-2.267381931344911,3.2800206236840523) -- cycle;
\fill[ fill=gray!20] (-2.267381931344911,3.2800206236840523) -- (-2.7221950728712114,1.4797186051424467) -- (-1.2251018153471387,1.062806558743338) -- cycle;
\fill[ fill=gray!20] (-2.7221950728712114,1.4797186051424467) -- (-2.13472809839974,-0.30163286583556315) -- (-1.2251018153471387,1.062806558743338) -- cycle;
\fill[ fill=gray!20] (-1.2251018153471387,1.062806558743338) -- (-0.5618326506212836,0) -- (-2.13472809839974,-0.30163286583556315) -- cycle;
\fill[ fill=gray!20] (-0.5618326506212836,0) -- (1,0) -- (-0.5428821030576877,-1.4197151720877181) -- cycle;
\fill[ fill=gray!20] (-2.13472809839974,-0.30163286583556315) -- (-0.5428821030576877,-1.4197151720877181) -- (-0.5618326506212836,0) -- cycle;
\fill[ fill=gray!20] (1,0) -- (1.5985297716286444,-1.4197151720877181) -- (-0.5428821030576877,-1.4197151720877181) -- cycle;
\fill[ fill=gray!20] (1,0) -- (1.8448868899553905,0.4184879415810791) -- (1.5985297716286444,-1.4197151720877181) -- cycle;
\fill[ fill=gray!20] (1.8448868899553905,0.4184879415810791) -- (3.796793289005764,0.19108137081792892) -- (1.5985297716286444,-1.4197151720877181) -- cycle;
\fill[ fill=gray!20] (1.8448868899553905,0.4184879415810791) -- (3.417782337733847,1.9155811991051512) -- (3.796793289005764,0.19108137081792892) -- cycle;
\fill[ fill=gray!20] (3.417782337733847,1.9155811991051512) -- (2.015441818027753,1.422866962451659) -- (1.8448868899553905,0.4184879415810791) -- cycle;
\fill[ fill=gray!20] (2.015441818027753,1.422866962451659) -- (1.39007374842909,2.1429877698683013) -- (3.417782337733847,1.9155811991051512) -- cycle;
\fill[ fill=gray!20] (3.417782337733847,1.9155811991051512) -- (2.849265910825971,3.3558228139384356) -- (1.39007374842909,2.1429877698683013) -- cycle;
\fill[ fill=gray!20] (1.39007374842909,2.1429877698683013) -- (1.636430866755836,4.113844716482269) -- (2.849265910825971,3.3558228139384356) -- cycle;
\fill[ fill=gray!20] (1.636430866755836,4.113844716482269) -- (0.6320518458852555,2.465147078449431) -- (1.39007374842909,2.1429877698683013) -- cycle;
\fill[ fill=gray!20] (-2.267381931344911,3.2800206236840523) -- (-0.2965249847309415,4.473905120190591) -- (-1.0734974348383717,1.9534822942323429) -- cycle;
\fill[ fill=gray!20] (-1.0734974348383717,1.9534822942323429) -- (-0.1828216993493664,2.446196530885835) -- (-0.2965249847309415,4.473905120190591) -- cycle;
\fill[ fill=gray!20] (-0.2965249847309415,4.473905120190591) -- (0.6320518458852555,2.465147078449431) -- (-0.1828216993493664,2.446196530885835) -- cycle;
\fill[ fill=gray!20] (-0.2965249847309415,4.473905120190591) -- (1.636430866755836,4.113844716482269) -- (0.6320518458852555,2.465147078449431) -- cycle;
...
\end{tikzpicture}
\caption{Suma conexa de un toro y una esfera visto como un toro con un \textit{cap}.\label{fig:suma_toro_esfera}}
\end{figure}
...
\end{tma}
\begin{proof}
Por la versión preeliminar del teorema de clasificación, una superficie con borde compacta conexa es homeomorfa a una esfera con handles, crosshandles, crosscaps y perforaciones.
\begin{itemize}
...
\item \textit{Caso 2:} No hay ni crosshandles ni crosscaps en la superficie. La superficie es entonces homeomorfa a una esfera sólo con handles y perforaciones.
\end{itemize}
\end{proof}
