...
\begin{proof}
Sea $S$ una superficie compacta. Sabemos, por el \nameref{teo:rado}, que $S$ está triangulada por un poliedro $|K|$ asociado a un complejo simplicial $K=\left\{\sigma_1,\dots ,\sigma_j\right\}$, donde cada $\sigma_i \text{ es un símplice para todo } i=1\dots ,j$, y tal que cada 1-símplice es una cara de exáctamente dos 2-símplices. Ahora bien, el complejo simplicial lo podemos construir a partir de 
\end{proof}
