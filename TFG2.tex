...
En las anteriores proposiciones hemos visto una o varias formas de representar superficies dadas ciertas construcciones geométricas. En estos casos hemos dado aplicaciones y demostraciones concretas para validar nuestros argumentos, pero a medida que aumenta la sofisticación es más útil guiarse visualmente por las figuras construidas. Por ello debemos formalizar un método para construir superficies identificando lados de figuras geométricas del plano.
...
\end{prop}
\begin{proof}
a) y b) son consecuencia directa de la \autoref{obs:suma_esfera}. Para c), utilizamos la \autoref{obs:asa}, utilzando para d) una construcción análoga. ((habría que especificar más?)).
\end{proof}
