...
Como vimos en \autoref{sec:tcsb}, las superficies con perforaciones se pueden representar como polígonos perforados con una serie de cortes (\autoref{fig:toro_perforado}). Esto nos da una forma natural de representar una superficie con cremalleras, etiquetando con el mismo símbolo las cremalleras asociadas al mismo par-zip, en la forma $z$ o $z^{-1}$, dependiendo de sus respectivas orientaciones. 
\begin{figure}
