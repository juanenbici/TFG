...
En el segundo capítulo estudio la demostración de la primera parte del Teorema de Clasificación, a la manera de Seifert-Threlfall, para poder compararla con la prueba de Conway. Con esta finalidad, presento un método riguroso de representación de cualquier superficie triangulada como un polígono en el plano. Introduzco entonces una serie transformaciones sobre este polígono que den lugar a superficies homeomorfas. Estos conceptos también me servirán para formalizar algunos pasos de la prueba ZIP. Finalmente, una vez probado el teorema, lo extiendo a las superficies con borde.\\

El tercer capítulo es la parte central del trabajo. Sigo paso por paso el artículo de Francis y Weeks, dando para cada resultado una demostración rigurosa, y definiendo formalmente las ideas de Conway. Para ello, me ayudo de algunos conceptos expuestos en el capítulo tres. Comento también donde procede las similitudes y diferencias con la prueba de Seifert-Threlfall, así como las posibles ventajas de una prueba u otra. El teorema que enuncio y demuestro da directamente la clasificación de las superficies con borde.\\
...
\setcounter{page}{1}
En este capítulo doy las definiciones y resultados básicos de las variedades, así como de las variedades con borde, que Conway utiliza en la Prueba ZIP sin mencionarlas ni definirlas. También estudiaremos la suma conexa de superficies, concepto en el que nos basaremos para llegar a una forma normal en la prueba de Conway. 
...
La suma conexa de variedades no depende de los puntos elegidos ni de los homeomorfismos $\varphi_1$ y $\varphi_2$, siempre que estas conserven su orientación durante el proceso. Aunque intuitivamente sea fácil de ver, la demostración de este resultado incluye el uso del \textit{annulus theorem}, cuya prueba incluye conceptos que no vamos a tratar en el trabajo. 
...
Sea $f$ un homeomorfismo entre dos curvas simples conexas $C$ y $C'$. Entonces $f$ se puede extender a un homeomorfismo de todo el plano.
\end{tma}
...
Ahora, para cada $q\in Q_3'$, sea $R(q)$ un cuadrado cuyo centro es $q$ y tal que $R(q)$ no interseca ni a $Q_1'$ ni a cualquier segmento malo que no es muy malo. Formamos con los $R(q)$ un recubrimiento finito de $Q'_3$, $R(q_1), \dots ,R(q_m)$. La unión $\bigcup_{i=1}^m$ es un grafo plano biconexo cuyo ciclo exterior, que llamamos $Q_3''$, es una curva poligonal simple en $\interior{Q_2(p_k)}$ tal que $Q_1' \subseteq Q_3''$ y tal que $Q_3''$ no corta a los segmentos malos de $Q_2(p_k)$ excepto los que son muy malos.

Obtenemos entonces que $\Gamma' \cup Q_3'' $ es un grafo biconexo, y redibujándolo y utilizando de nuevo el \autoref{tma:grafos} podemos asumir que $Q_3''$ es un rectángulo cuyo interior contiene a $Q_1$. Así pues, redefinimos $Q_1 (p_k) = Q_3''$, y obtenemos un cuadrilátero tal que $\theta_{p_k} (Q_1(p_k)) \cap \theta_{p_j} (Q_1 (p_j))$ es finita para todo $j=1, \dots , k-1$, demostrando por tanto la hipótesis de inducción.
...
%\draw (-2,0)--(2,0);
%\draw [rotate=15] (-2,0)--(2,0);
%\draw [rotate=30] (-2,0)--(2,0);
%\draw [rotate=45] (-2,0)--(2,0);
%\draw [rotate=60] (-2,0)--(2,0);
%\draw [rotate=75] (-2,0)--(2,0);
%\draw [rotate=90] (-2,0)--(2,0);
%\draw [rotate=105] (-2,0)--(2,0);
%\draw [rotate=120] (-2,0)--(2,0);
%\draw [rotate=135] (-2,0)--(2,0);
%\draw [rotate=150] (-2,0)--(2,0);
%\draw [rotate=165] (-2,0)--(2,0);
...
\filldraw [color=black!30] (-4.5,-.5) -- +(0,-.7) -- +(1,-.7) -- +(1,0) -- cycle;
\filldraw [color=black!30] (-4.5,.5) -- +(0,.7) -- +(1,.7) -- +(1,0) -- cycle;
...
\filldraw [color=black!30] (-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);
\filldraw [shift={(0,-3)},color=black!30] (-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);

\draw [dashed](-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);
\draw [dashed, shift={(0,-3)}](-.8,1.5) -- (-.8,2) -- (.8,2) -- (.8,1.5);

\draw [ very thick] (-.8,1.5) -- (.8,1.5);
\draw [very thick, shift={(0,-3)}] (-.8,1.5) -- (.8,1.5);

\draw (0,1) -- (0,2.2);
\draw (-1,1.5) -- (1,1.5);
\draw (0,1.5) node [anchor=north west]{$U_0$};
\draw (0,2.2) node [anchor=south west]{$\widehat{U}$};

\draw [shift={(0,-3)}] (0,1) -- (0,2.2);
\draw  [shift={(0,-3)}] (-1,1.5) -- (1,1.5);
\draw [shift={(0,-3)}](0,1.5) node [anchor=north west]{$V_0$};
\draw [shift={(0,-3)}](0,2.2) node [anchor=south west]{$\widehat{V}$};



\filldraw [color=black!30] (3.3,-.5) -- (3.3,.5) -- (4.8,.5) -- (4.8, -.5);
\draw [dashed] (3.3,-.5) -- (3.3,.5) -- (4.8,.5) -- (4.8, -.5) -- cycle;
\draw (3,0) -- (5,0);
\draw (4,-1) -- (4,1);


\draw [->] (-2.5,1) -- (-1.5,1.5) node [midway, above, sloped] {$\varphi$};
\draw [->] (-2.5,-1) -- (-1.5,-1.5) node [midway, above, sloped] {$\psi$};

\draw [->] (1.5,1.5) -- (2.5,1) node [midway, above, sloped] {$Id$};
\draw [->] (1.5,-1.5) -- (2.5,-1) node [midway, above, sloped] {$B$};
...
\begin{figure}[b]%%%%FIG: ejemplo operacion
\centering
...
\begin{figure}
\centering
\begin{tikzpicture}[use optics,scale=1.5, >= angle 60,scale=0.9]
\draw [->-](0,0)--(1,0);
\draw [-<-](0,1)--(1,1);
...
\section{Teorema de clasificación de superficies con borde}\label{sec:tcsb}
Podemos ahora clasificar las superficies con borde a partir del Teorema de Clasificación. Empecemos definiendo un concepto importante en la Prueba ZIP, el de perforación sobre una superficie.
...
%Por otro lado, el espacio cociente $M^*$ es IIAN. Para probar que es Haussdorf, hay que ver que las fibras de $\pi$ se pueden separar por abiertos saturados. Pero esto siempre es posible escogiendo bolas coordenadas suficientemente pequeñas. Así pues, $M^*$ es una superficie. 
\end{proof}
...
\begin{figure}
\centering
\begin{tikzpicture}[use optics, scale=2,>=angle 60, scale=0.8]

\draw (.5,1.5) -- +(1,0) -- (1.5,.5) ;
\draw [dashed] (1.5,.5) -- (.5,1.5);
\draw [dashed] (1.5,.5)[out=-90, in=-45] to (0,0) [out=135, in=180] to (.5,1.5) ;
\draw (0,0) node [anchor= north east] {$\partial M$};

\draw [shift={(3,0)}] (.5,1.5) -- +(1,0) -- (1.5,.5) ;
\draw [shift={(3,0)}, dashed] (1.5,.5) -- (.5,1.5);
...
\begin{figure}[h]
\centering
\begin{tikzpicture}[use optics,>=angle 60,scale=.7]
...
\begin{subfigure}{.5\textwidth}
\centering
\begin{tikzpicture}[use optics, >=angle 60, scale=1.7]
...
\begin{subfigure}{.5\textwidth}
\centering
\begin{tikzpicture}[use optics,scale=1.7]
...
\item[(ii)] Sea $|\mathcal{P}|$ la realización geométrica de $P$. Sea $\partial B$ una perforación sobre $\Esfera$, y sea $\phi$ un homeomorfismo entre las aristas de $|\mathcal{P}|$ y $\partial B$. Si identificamos ahora los pares de segmentos sobre $\partial B$ de la imagen de $\phi$ que se correspondan, obtenemos la misma superficie $M$. 
...
\end{tikzpicture}
\caption{Suma conexa de un toro y una esfera (visto como pegar un toro con un \textit{cap}).\label{fig:suma_toro_esfera}}
\end{figure}
...
\end{tikzpicture}
\caption{Suma conexa de una superficie y un toro visto como una superficie con un \textit{asa}. \label{fig:toro_asa}}
\end{figure}
...
También se puede demostrar directamente con la representación de la superficie y las cremalleras.
\end{proof}
...
Hasta ahora hemos demostrado, con dos enfoques distintos, que toda superficie con borde compacta es homeomorfa a una esfera, a una suma conexa de copias del toro o a una suma conexa de copias del plano proyectivo, junto con un número finito de perforaciones. Sin embargo no hemos demostrado que estas tres superficies estándar sean no homeomorfas entre sí. En este capítulo completaremos la parte de la prueba que nos falta. 
...
\begin{tikzpicture}[use optics,scale=0.7]
\draw (-3.8, 1.5) node {$X$};
\draw (-4,0) [out=-90, in=150] to (-3,-1.54)  [out=-30, in = 180] to (0,-2) [out=0, in =180] to (1.58,-1.71) [out=0, in = 180] to (3,-2) [out =0, in=-90] to (5,0) [out=90, in=-30] to (3.45,1.09) [out=150, in =0] to (0,1.4) [out=180, in=90] to (-4,0);
\draw [scale=0.8](1.8,0) arc [x radius= 1, y radius = 0.4, start angle =180, end angle =360];
\draw [scale=0.8]  (2,-.2) arc [x radius= 0.8, y radius=0.3, start angle=180,  end angle=0];

\draw [shift={(-4,0.3)},scale=0.7] (1.8,0) arc [x radius= 1, y radius = 0.4, start angle =180, end angle =360];
\draw [shift={(-4,0.3)}, scale=0.7] (2,-.2) arc [x radius= 0.8, y radius=0.3, start angle=180,  end angle=0];

\draw [color=white] (7,0) arc [x radius= 2, y radius =2, start angle=180, end angle= 360] node [color=black, anchor=north west, pos=0.6] {$a$};
\draw [color=white] (8,0) arc [x radius= 1, y radius =1, start angle=180, end angle= 360] node [color=black, anchor=north west, pos=0.6] {$c$};
\draw [->-={at=0.8}] (9,0) circle [radius=2] ;
\draw [->-={at=0.8}] (9,0) circle [radius=1] ;
\draw [->-={at=0.8}](9,0) -- (11,0) node [below, pos=0.8] {$b$};
\filldraw (9,0) circle [radius= 2pt];
\filldraw (11,0) circle [radius= 2pt] node [anchor=south west] {$v$};
\filldraw (10,0) circle [radius= 2pt] node [anchor=south west] {$p$};
\draw (9,0) node [above] {$z$};




%\draw [shift={(2,-7)}, dash pattern = on 390pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 2pt off 2pt on 700pt] (-4,0) [out=-90, in=150] to (-3,-1.54)  [out=-30, in = 180] to (0,-2) [out=0, in =180] to (1.58,-1.71) [out=0, in = 180] to (3,-2) [out =0, in=-90] to (5,0) [out=90, in=-30] to (3.45,1.09) [out=150, in =0] to (0,1.4) [out=180, in=90] to (-4,0);
\draw  [shift={(2,-7)}] (-3.8, 1.5) node {$\tilde{X}$};
\draw [shift={(2,-7)}, dash pattern =on 254pt off 65pt on 700pt] (-4,0) [out=-90, in=150] to (-3,-1.54)  [out=-30, in = 180] to (0,-2) [out=0, in =180] to (1.58,-1.71) [out=0, in = 180] to (3,-2) [out =0, in=-90] to (5,0) [out=90, in=-30] to (3.45,1.09) [out=150, in =0] to (0,1.4) [out=180, in=90] to (-4,0);
\draw [shift={(2,-7)},scale=0.8](1.8,0) arc [x radius= 1, y radius = 0.4, start angle =180, end angle =360];
\draw [shift={(2,-7)},scale=0.8]  (2,-.2) arc [x radius= 0.8, y radius=0.3, start angle=180,  end angle=0];



\draw [shift={(-2,-7.3)},scale=0.7] (1.8,0) arc [x radius= 1, y radius = 0.4, start angle =180, end angle =360];
\draw [shift={(-2,-7.3)}, scale=0.7] (2,-.2) arc [x radius= 0.8, y radius=0.3, start angle=180,  end angle=0];

\draw [shift={(1.4,-7)}, ->-={at=0.8}](1,-.2) arc [x radius= 1.8, y radius = 0.9, start angle =180, end angle =360] node [anchor=north west, pos=0.7] {$\tilde{a}$};
\filldraw [shift={(1.4,-7)}] (4.6,-.2) circle [radius=2pt] node [anchor=west] {$\tilde{v}$};
\draw [shift={(1.4,-7)},dashed](1,-.2) arc [x radius= 1.8, y radius = 0.9, start angle =180, end angle =0];


\draw [shift={(1.4,-7)}, ->- = {at=0.9}](1,-.2) arc [x radius= 1.8, y radius = 2.2, start angle =180, end angle =0] node [anchor= west, pos=0.9] {$\tilde{b}$};


\draw [shift={(1.4,-7)}, ->-={at=0.8}](1.5,1.3) arc [x radius= 1.3, y radius = 0.3, start angle =180, end angle =360]  node [anchor=north west, pos=0.7] {$\tilde{c}$};
\draw [shift={(1.4,-7)},, dashed](1.5,1.3) arc [x radius= 1.3, y radius = 0.3, start angle =180, end angle =0];
\filldraw [shift={(1.4,-7)}] (4.1,1.3) circle [radius=2pt] node [anchor=west] {$\tilde{p}$};


\draw [->](6,-2.8) -- (6,-3.8) node [anchor=west, midway] {$\pi$};
\end{tikzpicture}
\caption{Pegando una 2-celda\label{fig:2celda}}
\end{figure}
...
%Sea $\tilde{X}$ un espacio topológico Hausdorff y $X$ un subespacio de $X$ cerrado y conexo por caminos. Supongamos que existe $\varphi: \overline{\mathbb{B}}^2\to \tilde{X}$ tal que  y aplica $\partial \overline{\mathbb{B}}^2$ sobre $X$ y la restricción sobre $\interior{\overline{\mathbb{B}}^2}$ es biyectiva en $\tilde{X}\setminus X$. 
...
\begin{center}
\begin{tikzpicture}[use optics]
\draw [->](0,0) node [anchor=east] {$\pi_1 (\tilde{V} , \tilde{p} )$} -- (2,0) node [anchor=west] {$\pi_1 (\tilde{X} , \tilde{p} )$};
\draw [->]  (0,-1.5) node [anchor= east]{$\pi (\tilde{V} , \tilde{v} )$} -- (2,-1.5) node [anchor=west]{$\pi (\tilde{X} , \tilde{v} )$};

\draw [->] (-.55,-.35) -- (-.55,-1.15) node[anchor=west, midway]{$\Phi_{\tilde{b}}$};
\draw [->] (2.55,-.35) -- (2.55,-1.15) node[anchor=east, midway] {$\Phi_{\tilde{b}}$};
\end{tikzpicture}
\end{center}
...
\printbibheading
\printbibliography[keyword=bib, heading=subbibliography, title={Bibliografía principal}]
\printbibliography[notkeyword=bib, heading=subbibliography, title={Referencias Históricas}]
