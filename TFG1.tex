...
\draw [rotate around={0:(5.5,0)}] (5.5,0) ellipse (2.5cm and 2cm);
\draw [rotate around={0:(6.22,1.32)}] (6.22,1.32) ellipse (0.45cm and 0.28cm);
\draw(6.22,1.32) circle (0.45cm);
\draw (-6.5,0) arc[x radius=0.6, y radius=0.4, start angle=180, end angle=0];
\draw (-6.6,0.31) arc[x radius=0.7, y radius=0.4, start angle=180, end angle=360];
