...
Si $V$ es una $n$-variedad, la suma conexa $V\# \mathbb{S}^n$ es homeomorfa a $V$, al menos si hacemos las elecciones correctas (Fig. \ref{fig:suma_toro_esfera}).
\end{obs}
...
\draw [->>-][out=270, in=225] (3, 3.5) to (5,3.5);
\draw [-<<-][out=45, in=90] (5,3.5) to (7,3.5);
\draw [-<-][out=90, in=135] (3, 3.5) to (5,3.5);
\draw [->-][out=-45, in=-90] (5,3.5) to (7,3.5);

%4

\draw [out=90,in=360] (-1,-3) to (-3,-1.5);
\draw [out=180, in=90] (-3, -1.5) to (-5,-3);
\draw [->>-][out=270, in=225] (-5, -3) to (-3,-3);
\draw [dashed] [-<<-][out=45, in=90] (-3, -3) to (-1,-3);
%\draw (-5,-3) [->>-] arc[x radius=1, y radius=0.5, start angle=180, end angle=360];
\draw (-5,-3) arc[x radius=2, y radius=2.5, start angle=180, end angle=360];
\draw [->-](-3,-3)-- (-3,-1.5);
...
%5
\draw [-<<-] (3,-3)-- (3,-1.5);
\draw (1,-3) arc[x radius=2, y radius=2.5, start angle=180, end angle=360];
\draw [out=90,in=360] (5,-3) to (3,-1.5);
\draw [out=180, in=90] (3, -1.5) to (1,-3);
...
\fill [color=black] (-3,-3) circle (1.5pt);
\fill [color=black] (3,-1.5) circle (1.5pt);
\fill [color=black] (3,-3) circle (1.5pt);
\end{scriptsize}
\end{tikzpicture}
\caption{Construcción del gorro-cruzado a partir de la representación pologonal del plano proyectivo. \label{fig:crosscap_paso_a_paso}}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
