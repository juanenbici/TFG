...
\begin{itemize}
\item[(a)] $\mathbb{S}^2=\langle a|aa^{-1}\rangle=\langle a,b| abb^{-1}a^{-1}\rangle$ (\autoref{prop:Esfera como cociente de disco y cuadrado})
\item[(b)] $\mathbb{P}^2= \langle a|aa \rangle = \langle a,b|abab \rangle$ (\autoref{prop:proyectivo_cociente_cuadrado})
\item[(c)] $\Toro=\langle a,b|aba^{-1}b^{-1}\rangle$ (\autoref{prop:toro_cuadrado})
\end{itemize}
\end{eje}
...
Parece claro que una superficie puede tener varias presentaciones poligonales. Sea por ejemplo la presentación del toro $\Toro=\langle a,b|aba^{-1}b^{-1}\rangle$. Intuitivamente podemos ver que, subdividiendo los lados etiquetados con $b$, y reetiquetándolos con $c$ y $d$ (ver \ref{fig:ejemplo_operacion}), la superficie que representa la representación obtenida $\langle a,c,d| acda^{-1}c^{-1}d^{-1}\rangle$ será la misma.
