...
\draw [->-={at=0.25}, -<<-={at=0.75}](6,2) arc[x radius=0.7, y radius=2, start angle=90, end angle=270];
\begin{scriptsize}
...
\centering
\begin{tikzpicture}
%\draw plot [smooth cycle] coordinates {(-4,0) (-3.414213562,1.414213562) (-2,2) (-1,1.732050808) (0,1.5)(1,1.732050808) (2,2) ((3.414213562,1.414213562) (4,0) (3.414213562,-1.414213562) (2,-2) (1,-1.732050808) (0,-1.5) (-1,-1.732050808) (-2,-2) (-3.414213562,-1.414213562)};
\draw plot [smooth cycle, tension=0.9] coordinates {(-4,0)  (-2,2)  (0,1.5) (2,2)  (4,0)  (2,-2)  (0,-1.5)  (-2,-2)};
\draw (-1.3,0.13) arc[x radius=0.5, y radius=0.2, start angle=0, end angle=-180];
\draw (-1.5,0) arc[x radius=0.3, y radius=0.2, start angle=0, end angle=180]; 
\draw (2.2,0.13) arc[x radius=0.5, y radius=0.2, start angle=0, end angle=-180];
\draw (2,0) arc[x radius=0.3, y radius=0.2, start angle=0, end angle=180]; 
...
\begin{prop}%%%%PROP: representación de superficies importantes
Se tiene que 
\begin{itemize}
\item[a] $\mathbb{S}^2=\langle a|aa^{-1}\rangle=\langle a,b| aba^{-1}b^{-1}\rangle$.
\item[b] $\mathbb{P}^2= \langle a|aa \rangle = \langle a,b|abab \rangle$.
\end{itemize}
\end{prop}
